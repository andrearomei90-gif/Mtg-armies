/* Armies Builder 4.6.0: endpoint opzionale non usato dal Geniere gratuito locale. */
const cors = {
...
export async function onRequestPost(context) {
  ...
  const response = await fetch('https://api.openai.com/v1/responses', {
    ...
    body: JSON.stringify({
      ...
      input: prompt,
      max_output_tokens: mode === 'design' ? 16000 : 5000,
